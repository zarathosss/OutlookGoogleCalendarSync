...
namespace OutlookGoogleCalendarSync.Forms {
    public partial class Social : Form {
        ...
        public static void Twitter_tweet() {
            ...
            Program.BrowseToUrl("http://twitter.com/intent/tweet?&url=http://bit.ly/OGCalSync&text=" + urlEncode(text) + "&via=ogcalsync");
        }
        public static void Twitter_follow() {
            Program.BrowseToUrl("https://twitter.com/OGcalsync");
        }

        public static void Facebook_share() {
            Program.BrowseToUrl("http://www.facebook.com/sharer/sharer.php?u=http://bit.ly/OGCalSync");
        }
        public static void Facebook_like() {
            if (OgcsMessageBox.Show("Please click the 'Like' button on the project website, which will now open in your browser.",
                ...
                Program.BrowseToUrl("https://phw198.github.io/OutlookGoogleCalendarSync");
            }
        }

        public static void RSS_follow() {
            Program.BrowseToUrl("https://github.com/phw198/OutlookGoogleCalendarSync/releases.atom");
        }

        public static void Linkedin_share() {
            string text = "I'm using this Outlook-Google calendar sync tool - completely #free and feature loaded. #recommend";
            Program.BrowseToUrl("http://www.linkedin.com/shareArticle?mini=true&url=http://bit.ly/OGCalSync&summary=" + urlEncode(text));
        }

        public static void GitHub() {
            Program.BrowseToUrl("https://github.com/phw198/OutlookGoogleCalendarSync/");
        }
